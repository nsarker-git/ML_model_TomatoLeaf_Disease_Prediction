...
def model_predict(img_path, model):
   ...
   # x = preprocess_input(x)
    ...
    if preds==0:
        ...
        preds="The Disease is Pepper__healthy"
    elif preds==3:
        preds="Te Disease is Potato_Late_healthy"
    elif preds==4:
        preds="The Disease is Potato___Late_Mold"
    elif preds==5:
        preds="The Disease is Tomato__Septoria_leaf_spot"
    elif preds==6:
        preds="The Disease is Tomato__Spider_mite_two_spotted"
    elif preds==7:
        preds="The Disease is Tomato_target_spot"
    elif preds==8:
        preds="The Disease is Tomato_mosaic_virus"
    elif preds==9:
        preds="The Disease is Tomato_Yellow_leaf_curl"
